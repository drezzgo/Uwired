...
function Valorant() {
  ...
  if (instalacion == "si") {
    // HECHO - No importa, se efectua normal

    if (pire_antena <= 40) {
      // HECHO - Si es menor o igual a 40 dBm, solo importa su altura
      ///////////////////////////////////////////////
      //////////////PIRE MENOR A 40 dbm//////////////
      //////////////////////////////////////////////

      distancia_minima_horizontal_PG = determinar_dm(
        banda_antena,
        frecuencia,
        alturaCentro_Persona,
        pire_antena_W,
        1
      ); //Imprimir la distancia
      distancia_minima_horizontal_OC = determinar_dm(
        banda_antena,
        frecuencia,
        alturaCentro_Persona,
        pire_antena_W,
      ...
      if (
        distancia_minima_horizontal_PG > 0 ||
        distancia_minima_horizontal_OC > 0
      ) {
        alert(
          "La distancia minima horizontal a la estructura publico general : " +
            distancia_minima_horizontal_PG.toFixed(2) +
            " m\n\n" +
            "La distancia minima horizontal ocupacional a la estructura : " +
            distancia_minima_horizontal_OC.toFixed(2) +
            " m\n\n" +
      ...
      if (altura < 2.2) {
        // HECHO - Si la altura es menor de 2.2, esta mal
        ...
        Necesita_senalizacion4 = document.getElementById(
          "necesita_senalizacion1"
        );
        ...
        if (
          ...
          Necesita_senalizacion4.textContent =
            "Requiere de establecer una señalizacion correspondiente a la distancia minima poblacional y ocupacional";
          distancia_ocupacional4.textContent =
            "La distancia ocupacional corresponderia a " +
            distancia_minima_horizontal_OC.toFixed(2) +
            " metros, para publico general corresponde a " +
            distancia_minima_horizontal_PG.toFixed(2) +
            " metros";
        } else {
          Necesita_Medicion4.textContent = "No requiere de hacer medicion";
          Necesita_senalizacion4.textContent =
            "No requiere de establecer una señalizacion correspondiente a la distancia minima poblacional ni ocupacional";
        }

        document.querySelector(".logo").style.display = "none";
        document.querySelector(".Pm40am2").classList.remove("hidden");
      } else {
        // HECHO - Si no es menor, es porque esta bien entonces se evalua
        pire_valor_span = document.getElementById("pire_valor1_2");
        pire_valor_span.textContent = pire_antena;

        Necesita_Medicion4 = document.getElementById("necesita_medicion1_2");
        Necesita_senalizacion4 = document.getElementById(
          "necesita_senalizacion1_2"
        );
    ...
    } else if (pire_antena <= 50) {
      // HECHO - Si es menor a 50 dBm, importa altura y frecuencia
      ...
      if (altura < 2.5) {
        ...
        // Si es mayor, se evalua si Frec. es menor que 1500 mHz
        ...
        // Si no es menor, es mayor o igual a 1500 mHZ
    ...
    } else if (pire_antena <= 53) {
      // HECHO - si es menor a 53 dBm, hasta este punto no es necesario medir
      distancia_minima_horizontal_PG = determinar_dm(
        banda_antena,
        frecuencia,
        alturaCentro_Persona,
      ...
      // HECHO - Al ser mayor a 53dBm, es necesario medir
      distancia_minima_horizontal_PG = determinar_dm(
        banda_antena,
        frecuencia,
        alturaCentro_Persona,
    ...
    //  HECHO - Importa saber, si hay antenas

    var existe_antena = document.getElementById("antena_cerca").value;
    if (existe_antena == "no") {
      // HECHO - Si no hay antenas es lo mismo que si ya estuviera instalada, no importa
      ...
      // HECHO -Depende el PIRE es importante saber o no, las otras antenas
      ...
      var antenajena_frecuencia = document.getElementById(
        "frecuencia_antenajena"
      ).value;
      distancia_minima_horizontal_PG = determinar_dm(
        banda_antena,
        frecuencia,
      ...
      if (pire_antena <= 50 && pire_antena > 40) {
        // HECHO - pire menor a 50, vale verga

        if (antenajena_watts > 10) {
          // Si el PIRE es mayor a 10 W importa que la distancia sea mayor a 10 m

          if (antenajena_metros > 10 && antenajena_frecuencia < 1500) {
            //Se puede instalar
            respuesta.textContent =
              "la resolucion establece que las antenas cercanas si son menores de 1500 mHz pueden estar a un maximo de 10 metros desde la base de la estructura";
            ...
            Necesita_senalizacion = document.getElementById(
              "necesita_senalizacion5"
            );
            ...
            if (
              ...
              Necesita_senalizacion.textContent =
                "Requiere de establecer una señalizacion correspondiente a la distancia minima poblacional y ocupacional";
              distancia_ocupacional.textContent =
                "La distancia ocupacional corresponderia a " +
                distancia_minima_horizontal_OC.toFixed(2) +
                " metros, para publico general corresponde a " +
                distancia_minima_horizontal_PG.toFixed(2) +
            ...
            document.querySelector(".logo").style.display = "none";
            document
              .querySelector(".antejanena_sepuede")
              .classList.remove("hidden");
          } else if (antenajena_metros > 5 && antenajena_frecuencia > 1500) {
            // se puede instalar pero a 5 metros

            respuesta = document.getElementById("respuesta6");
            Necesita_Medicion = document.getElementById("necesita_medicion6");
            Necesita_senalizacion = document.getElementById(
              "necesita_senalizacion6"
            );
            distancia_ocupacional = document.getElementById("distancias6");
            respuesta.textContent =
              "la resolucion establece que las antenas cercanas si son mayores de 1500 mHz pueden estar a un maximo de 5 metros desde la base de la estructura";
            ...
            document.querySelector(".logo").style.display = "none";
            document
              .querySelector(".antejanena_sepuede_5M")
              .classList.remove("hidden");
          } else {
            //No se puede instalar pa, te falta
            Necesita_Medicion3 = document.getElementById("necesita_medicion7");
            Necesita_senalizacion3 = document.getElementById(
              "necesita_senalizacion7"
            );
            ...
            respuesta.textContent =
              "la resolucion establece que NO puede instalar la estacion de radiofrecuencia dado que hay antenas muy cercanas en su rango de frecuencia";
            ...
            if (
              ...
              Necesita_senalizacion3.textContent =
                "Requiere de establecer una señalizacion correspondiente a la distancia minima poblacional y ocupacional";
              distancia_ocupacional3.textContent =
                "La distancia ocupacional corresponderia a " +
                distancia_minima_horizontal_OC.toFixed(2) +
                " metros, para publico general corresponde a " +
                distancia_minima_horizontal_PG.toFixed(2) +
            ...
            document.querySelector(".logo").style.display = "none";
            document
              .querySelector(".antenajena_nosepuede")
              .classList.remove("hidden");
          }
        }
      } else if (pire_antena > 50) {
        // HECHO -Si es mayor a 50,

        if (
          antenajena_watts > 100 &&
          antenajena_metros <= distancia_minima_horizontal_PG
        ) {
          // HECHO -

          Necesita_Medicion3 = document.getElementById("necesita_medicion8");
          Necesita_senalizacion3 = document.getElementById(
            "necesita_senalizacion8"
          );
          ...
          document.querySelector(".logo").style.display = "none";
          document
            .querySelector(".antenajena_nosepuede_M50")
            .classList.remove("hidden");
        } else {
          // HECHO - si se puede poner

          Necesita_Medicion = document.getElementById("necesita_medicion9");
          Necesita_senalizacion = document.getElementById(
            "necesita_senalizacion9"
          );
          ...
          document.querySelector(".logo").style.display = "none";
          document
            .querySelector(".antejanena_sepuede_M50")
            .classList.remove("hidden");
        }
      }
    }
...
function determinar_dm(
  ...
  if (tipo == 1) {
    //retornar distancia minima publico general en horizontal
    return mDHPG;
  } else if (tipo == 2) {
    //retornar distancia minima ocupacional en horizontal
    return mDHOP;
  }
}
...
function PIRE(unidad) {
  ...
  if (unidad == 1) {
    alert(
      "Profe Marlon, aqui los resultados que comprueban el procedimiento, segun los datos que ingresaste : \n\n" +
        "Convirtiendo los Watts a dBm serian : " +
        potencia_dbm.toFixed(1) +
        "\n" +
        "Junto con la ganancia equivale a un PIRE de : " +
        piredbm +
        "\n\n" +
        "Teniendo en cuenta el tipo de antena " +
        modelo_antena +
        " este debe tener un producto de reduccion por lo tanto :\n\n" +
        "El PIRE con la atenuacion en Watts seria : " +
        pire_prueba.toFixed(3) +
        " \n( . a la derecha son decimales)\n" +
        "El PIRE con la atenuacion en dBm seria : " +
        pire_dbm
    );
